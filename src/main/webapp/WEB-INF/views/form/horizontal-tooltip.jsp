...
<head>
<meta charset="utf-8">
<title>Form / Horizontal Tooltip</title>
...
<body>
    <div id="wrapper" class="container-fluid">
        <ol class="breadcrumb">
            ...
            <li class="active">Horizontal Tooltip</li>
        </ol>
                ...
                <form:form method="post" modelAttribute="inputForm" class="form-horizontal">
                    ...
                    <div class="form-group ${errors.hasFieldErrors('password') ? 'has-error' : ''}">
                        ...
                        <div class="col-sm-10">
                            ...
                            <form:errors path="password" cssClass="hidden" />
                        </div>
                    </div>
                    ...
                    <div class="form-group ${errors.hasFieldErrors('select') ? 'has-error' : ''}">
                        ...
                        <div class="col-sm-10">
                            ...
                            <form:errors path="select" cssClass="hidden" />
                        </div>
                    </div>
                    ...
                    <div class="form-group ${errors.hasFieldErrors('date') ? 'has-error' : ''}">
                        ...
                        <div class="col-sm-10">
                            ...
                            <form:errors path="date" cssClass="hidden" />
                        </div>
                    </div>
