...
<head>
<meta charset="utf-8">
<title>Form / Horizontal Inline</title>
...
<body>
    <div id="wrapper" class="container-fluid">
        <ol class="breadcrumb">
            ...
            <li class="active">Horizontal Inline</li>
        </ol>
            ...
            <div class="panel-body">
                ...
                <form:form method="post" modelAttribute="inputForm" class="form-horizontal">
                    ...
                    <div class="form-group">
                        <div class="${errors.hasFieldErrors('input') ? 'has-error' : ''}">
                            <form:label path="input" cssClass="control-label col-sm-1">Input</form:label>
                            <div class="col-sm-5">
                        ...
                        <div class="${errors.hasFieldErrors('password') ? 'has-error' : ''}">
                            <form:label path="password" cssClass="control-label col-sm-1">Password</form:label>
                            <div class="col-sm-5">
                    ...
                    <div class="form-group">
                        <div class="${errors.hasFieldErrors('select') ? 'has-error' : ''}">
                            <form:label path="select" cssClass="control-label col-sm-1">Select</form:label>
                            <div class="col-sm-5">
                        ...
                        <div class="${errors.hasFieldErrors('date') ? 'has-error' : ''}">
                            <form:label path="date" cssClass="control-label col-sm-1">Date</form:label>
                            <div class="col-sm-5">
